...
export class DriverRouteComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const deliveryRoutes = [
      ...
      { driver_name: 'Armen', customer_name: 'GOURMET FOOD SOLUTIONS', address: '821 Traction Ave, Los Angeles, CA 90013', delivery_date: new Date(), has_arrived: true, status: 'Arrived', delivery_time: new Date(), photo: '' },
      ...
      { driver_name: 'Armen', customer_name: 'AMANTE', address: '2100 Sunset Blvd, Los Angeles, CA 90026', delivery_date: new Date(), has_arrived: true, status: 'Arrived', delivery_time: new Date(), photo: '' },
      ...
      { driver_name: 'Narek', customer_name: 'PHORAGE', address: '3300 Overland Ave, Los Angeles, CA 90034', delivery_date: new Date(), has_arrived: true, status: 'Arrived', delivery_time: new Date(), photo: '' },
      ...
      { driver_name: 'Narek', customer_name: 'DACSU LLC', address: '655 S Main St, Los Angeles, CA 90014', delivery_date: new Date(), has_arrived: true, status: 'Arrived', delivery_time: new Date(), photo: '' },
      ...
      { driver_name: 'Tigran', customer_name: 'CAROUSEL / NAIRI', address: '5112 Hollywood Blvd, Los Angeles, CA 90027', delivery_date: new Date(), has_arrived: true, status: 'Arrived', delivery_time: new Date(), photo: '' },
      ...
      { driver_name: 'Tigran', customer_name: 'THE COPPER KEY', address: '6363 Wilshire Blvd, Los Angeles, CA 90048', delivery_date: new Date(), has_arrived: true, status: 'Arrived', delivery_time: new Date(), photo: '' },
      ...
      { driver_name: 'Aram', customer_name: 'CAROUSEL / NAIRI', address: '5112 Hollywood Blvd, Los Angeles, CA 90027', delivery_date: new Date(), has_arrived: true, status: 'Arrived', delivery_time: new Date(), photo: '' },
      ...
      { driver_name: 'Aram', customer_name: 'RAPPAHANNOCK OYSTER BAR', address: '1318 E 7th St, Los Angeles, CA 90021', delivery_date: new Date(), has_arrived: true, status: 'Arrived', delivery_time: new Date(), photo: '' },
      ...
      { driver_name: 'Garen', customer_name: 'CHARCOAL RESTAURANT-VENICE', address: '425 Washington Blvd, Venice, CA 90291', delivery_date: new Date(), has_arrived: true, status: 'Arrived', delivery_time: new Date(), photo: '' },
      ...
      { driver_name: 'Garen', customer_name: 'GO TRUCKS CATERING', address: '221 S Grand Ave, Los Angeles, CA 90012', delivery_date: new Date(), has_arrived: true, status: 'Arrived', delivery_time: new Date(), photo: '' },
